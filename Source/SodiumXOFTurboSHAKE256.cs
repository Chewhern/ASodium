...
namespace ASodium
{
    public static class SodiumXOFTurboSHAKE256
    {
        public static int GetBlockBytesLength()
        {
            return SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256_blockbytes();
        }

        public static int GetStateBytesLength()
        {
            return SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256_statebytes();
        }

        public static Byte GetDomainStandardByte()
        {
            return SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256_domain_standard();
        }
        ...
        public static Byte[] ComputeHash(Byte[] Message, long HashedMessageLength)
        {
            ...
            int result = SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256(HashedMessage, HashedMessageLength, Message, Message.LongLength);
        ...
        public static Byte[] InitStateBytes()
        {
            ...
            int result = SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256_init(State);
        ...
        public static Byte[] InitStateBytesWithCustomDomainByte(Byte CustomDomainByte)
        {
            ...
            int result = SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256_init_with_domain(State, CustomDomainByte);
        ...
        public static Byte[] UpdateState(Byte[] State, Byte[] DataStream, Boolean ClearKey = false)
        {
            ...
            int result = SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256_update(State, DataStream, DataStream.LongLength);
        ...
        public static IntPtr UpdateState(IntPtr State, IntPtr SecretDataStream, long SecretDataStreamLength, Boolean ClearKey = false)
        {
            ...
            int result = SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256_update(State, SecretDataStream, SecretDataStreamLength);
        ...
        public static Byte[] SqueezeData(Byte[] State, long SqueezedDataLength, Boolean ClearKey = false)
        {
            ...
            int result = SodiumXOFTurboSHAKE256Library.crypto_xof_turboshake256_squeeze(State, SqueezedData, SqueezedDataLength);
