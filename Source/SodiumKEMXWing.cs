...
namespace ASodium
{
    public static class SodiumKEMXWing
    {
        public static int GetPublicKeyBytesLength()
        {
            return SodiumKEMXWingLibrary.crypto_kem_xwing_publickeybytes();
        }

        public static int GetPrivateKeyBytesLength()
        {
            return SodiumKEMXWingLibrary.crypto_kem_xwing_secretkeybytes();
        }

        public static int GetCipherTextBytesLength()
        {
            return SodiumKEMXWingLibrary.crypto_kem_xwing_ciphertextbytes();
        }

        public static int GetSharedSecretBytesLength()
        {
            return SodiumKEMXWingLibrary.crypto_kem_xwing_sharedsecretbytes();
        }

        public static int GetSeedBytesLength()
        {
            return SodiumKEMXWingLibrary.crypto_kem_xwing_seedbytes();
        }
        ...
        public static RevampedKeyPair GenerateSeededRevampedKeyPair(Byte[] Seed, Boolean ClearKey = false)
        {
            ...
            SodiumKEMXWingLibrary.crypto_kem_xwing_seed_keypair(PublicKey, PrivateKey, Seed);
        ...
        public static RevampedKeyPair GenerateRevampedKeyPair()
        {
            ...
            SodiumKEMXWingLibrary.crypto_kem_xwing_keypair(PublicKey, PrivateKey);
        ...
        public static EncapsulatedSharedSecretBox EncapsulateSecretKeyBytes(Byte[] PublicKey, Byte[] Seed, Boolean ClearKey=false)
        {
            ...
            else 
            {
                if (Seed.Length != 64) 
                {
                    throw new ArgumentException("Error: Seed must be 64 bytes in length");
                }
            }
            Byte[] SharedSecret = new Byte[GetSharedSecretBytesLength()];
            Byte[] CipherText = new Byte[GetCipherTextBytesLength()];

            int result = SodiumKEMXWingLibrary.crypto_kem_xwing_enc_deterministic(CipherText, SharedSecret, PublicKey,Seed);
        ...
        public static EncapsulatedSharedSecretBox EncapsulateSecretKeyBytes(Byte[] PublicKey)
        {
            ...
            int result = SodiumKEMXWingLibrary.crypto_kem_xwing_enc(CipherText, SharedSecret, PublicKey);
        ...
        public static Byte[] DecapsulateSharedSecret(Byte[] CipherText, Byte[] PrivateKey, Boolean ClearKey = false)
        {
            ...
            int result = SodiumKEMXWingLibrary.crypto_kem_xwing_dec(SharedSecret, CipherText, PrivateKey);
