...
namespace Sodium
{
    ...
    {
        /// <returns>Returns Boolean to check if this machine can use AES256GCM hardware accelerated version</returns>
        ...
        /// <summary>Generates a random nonce.</summary>
        ...
        /// <returns>Returns key in bytes</returns>
        ...
        /// <summary>Generates a random key.</summary>
        /// <returns>Returns key in read protected IntPtr</returns>
        ...
        /// <summary>Initializes state used by AES256 GCM.</summary>
        /// <returns>Returns state in bytes</returns>
        ...
        /// <summary>Initializes state used by AES256 GCM.</summary>
        /// <returns>Returns state in read protected IntPtr</returns>
