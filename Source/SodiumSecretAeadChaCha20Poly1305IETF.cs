...
namespace Sodium
{
    public static class SodiumSecretAeadChaCha20Poly1305IETF
    {
        ...
        public static Byte[] GenerateKey()
        {
            ...
            Sodium.SodiumSecretAeadChaCha20Poly1305IETFLibrary.crypto_aead_chacha20poly1305_ietf_keygen(Key);
            return Key;
        }
        ...
        public static ChaCha20Poly1305DetachedBox CreateDetachedBox(Byte[] Message, Byte[] NoncePublic, Byte[] Key, Byte[] NonceSec = null, Byte[] AdditionalData = null)
        {
            ...
            int result = SodiumSecretAeadChaCha20Poly1305IETFLibrary.crypto_aead_chacha20poly1305_ietf_encrypt_detached(CipherText, MAC, MACLength, Message, MessageLength, AdditionalData, AdditionalDataLength, NonceSec, NoncePublic, Key);
