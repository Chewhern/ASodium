...
namespace ASodium
{
    public static partial class SodiumPasswordHashScryptSalsa208SHA256Library
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_pwhash_scryptsalsa208sha256(IntPtr DerivedKey, long DerivedKeyLength, IntPtr Password, long PasswordLength, Byte[] Salt, long OpsLimit, long MemLimit);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_pwhash_scryptsalsa208sha256_str(Byte[] ComputedPasswordHashWithParams, IntPtr Password, long PasswordLength, long OpsLimit, long MemLimit);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_pwhash_scryptsalsa208sha256_str_verify(String ComputedPasswordHashWithParamsString, IntPtr Password, long PasswordLength);
