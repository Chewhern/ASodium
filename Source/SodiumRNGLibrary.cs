...
namespace ASodium
{
    public static partial class SodiumRNGLibrary
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void randombytes_buf(IntPtr RNGData, int size);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void randombytes_buf_deterministic(IntPtr RNGData, long size, IntPtr Seeds);
