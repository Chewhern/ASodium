...
namespace LibSodiumBinding
{
    public partial class SodiumGuardedHeapAllocationDemo : Form
    {
        ...
        {
            Boolean IsZero = true;
            IntPtr MyIntPtr = Sodium.SodiumGuardedHeapAllocation.Sodium_Malloc(ref IsZero, 32);
            if (IsZero == false) 
            {
        ...
        {
            Boolean IsZero = true;
            IntPtr MyIntPtr = Sodium.SodiumGuardedHeapAllocation.Sodium_AllocArray(ref IsZero,16,1);
            if (IsZero == false)
            {
                MessageBox.Show("Successfully allocate space for IntPtr");
            }
        ...
        private void SodiumFreeBTN_Click(object sender, EventArgs e)
        {
            ...
            if (IsZero == false)
            {
                ...
                Sodium.SodiumGuardedHeapAllocation.Sodium_Free(MyIntPtr);
                //==
        ...
        private void NoAccessBTN_Click(object sender, EventArgs e)
        {
            ...
            if (IsZero == false)
            {
                ...
                Sodium.SodiumGuardedHeapAllocation.Sodium_MProtect_NoAccess(MyIntPtr);
                //Marshal.Copy(RandomByte, 0, MyIntPtr, 32);
            }
        }
        ...
        private void ReadOnlyBTN_Click(object sender, EventArgs e)
        {
            ...
            if (IsZero == false)
            {
                ...
                Sodium.SodiumGuardedHeapAllocation.Sodium_MProtect_ReadOnly(MyIntPtr);
                //Marshal.Copy(RandomByte, 0, MyIntPtr, 32);
            }
        }
        ...
        private void ReadWriteBTN_Click(object sender, EventArgs e)
        {
            ...
            {
                Marshal.Copy(RandomByte, 0, MyIntPtr, 32);
                Sodium.SodiumGuardedHeapAllocation.Sodium_MProtect_ReadWrite(MyIntPtr);
