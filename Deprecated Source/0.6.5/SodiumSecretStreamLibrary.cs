...
namespace ASodium
{
    public static partial class SodiumSecretStreamLibrary
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_secretstream_xchacha20poly1305_keygen(IntPtr Key);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_secretstream_xchacha20poly1305_init_push(Byte[] StateByte,Byte[] HeaderByte,Byte[] KeyByte);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_secretstream_xchacha20poly1305_init_push(IntPtr StateByte, IntPtr HeaderByte, IntPtr KeyByte);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_secretstream_xchacha20poly1305_push(IntPtr StateByte, Byte[] CipherText, long CipherTextLength, Byte[] Message, long MessageLength, Byte[] AdditionalData, long AdditionalDataLength, Byte Tag);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_secretstream_xchacha20poly1305_init_pull (Byte[] StateByte, Byte[] HeaderByte, Byte[] KeyByte);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_secretstream_xchacha20poly1305_init_pull(IntPtr StateByte, IntPtr HeaderByte, IntPtr KeyByte);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_secretstream_xchacha20poly1305_pull(IntPtr StateByte, Byte[] MessageByte, long MessageLength, Byte Tag, Byte[] CipherText, long CipherTextLength, Byte[] AdditionalData, long AdditionalDataLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_secretstream_xchacha20poly1305_rekey(Byte[] StateByte);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_secretstream_xchacha20poly1305_rekey(IntPtr StateByte);
    }
}
