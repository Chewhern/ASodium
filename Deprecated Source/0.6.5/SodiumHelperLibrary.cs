...
namespace ASodium
{
    public static partial class SodiumHelperLibrary
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int sodium_memcmp(IntPtr Pointer1, IntPtr Pointer2, long BytesArrayMutualSize);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void sodium_increment(IntPtr NumberByte, int NumberByteLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void sodium_add(Byte[] NumberByte1, Byte[] NumberByte2, int NumberBytesMutualLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void sodium_add(IntPtr NumberByte1, IntPtr NumberByte2, int NumberBytesMutualLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void sodium_sub(Byte[] NumberByte1, Byte[] NumberByte2, int NumberBytesMutualLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void sodium_sub(IntPtr NumberByte1, IntPtr NumberByte2, int NumberBytesMutualLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int sodium_compare(Byte[] ByteArray1, Byte[] ByteArray2, long NumberBytesMutualLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int sodium_compare(IntPtr ByteArray1, IntPtr ByteArray2, long NumberBytesMutualLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int sodium_is_zero(Byte[] Data, int DataLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int sodium_is_zero(IntPtr Data, int DataLength);
