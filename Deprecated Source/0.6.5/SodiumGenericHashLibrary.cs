...
namespace ASodium
{
    public static partial class SodiumGenericHashLibrary
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_generichash(Byte[] ComputedHash, int ComputedHashLength, Byte[] Message, long MessageLength, IntPtr Key, int KeyLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_generichash_init(Byte[] State,Byte[] Key,int KeyLength,Byte OutLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_generichash_init(IntPtr State, IntPtr Key, int KeyLength, Byte OutLength);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_generichash_final(IntPtr State, Byte[] ComputedHash, int ComputedHashLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_generichash_keygen(Byte[] Key);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_generichash_keygen(IntPtr Key);
    }
}
