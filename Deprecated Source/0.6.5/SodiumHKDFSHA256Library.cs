...
namespace ASodium
{
    public static partial class SodiumHKDFSHA256Library
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_kdf_hkdf_sha256_extract_init(IntPtr State, Byte[] Salt, int SaltLength);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_kdf_hkdf_sha256_extract_update(IntPtr State, IntPtr InputKeyMaterial, long InputKeyMaterialLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_kdf_hkdf_sha256_extract_final(Byte[] State, Byte[] MasterKey);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_kdf_hkdf_sha256_extract_final(IntPtr State, IntPtr MasterKey);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_kdf_hkdf_sha256_extract(IntPtr MasterKey, Byte[] Salt, int SaltLength, IntPtr InputKeyMaterial, long InputKeyMaterialLength);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_kdf_hkdf_sha256_keygen(Byte[] Key);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_kdf_hkdf_sha256_keygen(IntPtr Key);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_kdf_hkdf_sha256_expand(IntPtr SubKey, int SubKeyLength, Byte[] Context, int ContextLength, IntPtr MasterKey);
