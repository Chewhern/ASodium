...
namespace ASodium
{
    public static class SodiumStreamCipherXSalsa20
    {
        ...
        public static IntPtr XSalsa20GenerateKeyIntPtr()
        {
            ...
            if (IsZero == false)
            {
                SodiumStreamCipherXSalsa20Library.crypto_stream_xsalsa20_keygen(KeyIntPtr);
        ...
        public static Byte[] XSalsa20Encrypt(Byte[] Message, Byte[] Nonce, Byte[] Key,Boolean ClearKey=false)
        {
            ...
            if (result != 0)
            {
                throw new CryptographicException("Failed to encrypt using XSalsa20 stream cipher");
            }
        ...
        public static Byte[] XSalsa20Encrypt(Byte[] Message, Byte[] Nonce, IntPtr Key, Boolean ClearKey = false)
        {
            if (Message == null)
            {
                throw new ArgumentException("Error: Message must not be null");
        ...
        public static Byte[] XSalsa20Decrypt(Byte[] CipherText, Byte[] Nonce, IntPtr Key, Boolean ClearKey = false)
        {
            return XSalsa20Encrypt(CipherText, Nonce, Key, ClearKey);
        }

        public static Byte[] XSalsa20StraightEncrypt(Byte[] Message, Byte[] Nonce, Byte[] Key, ulong IC,Boolean ClearKey=false)
        {
            if (Message == null)
            {
                throw new ArgumentException("Error: Message must not be null");
            ...
            if (result != 0)
            {
                throw new CryptographicException("Failed to straight encrypt using XSalsa20 stream cipher");
            }
        ...
        public static Byte[] XSalsa20StraightEncrypt(Byte[] Message, Byte[] Nonce, IntPtr Key, ulong IC, Boolean ClearKey = false)
        {
            if (Message == null)
            {
                throw new ArgumentException("Error: Message must not be null");
        ...
        public static Byte[] XSalsa20StraightDecrypt(Byte[] CipherText, Byte[] Nonce, Byte[] Key, ulong IC, Boolean ClearKey = false)
        {
            return XSalsa20StraightEncrypt(CipherText, Nonce, Key, IC,ClearKey);
        }

        public static Byte[] XSalsa20StraightDecrypt(Byte[] CipherText, Byte[] Nonce, IntPtr Key, ulong IC, Boolean ClearKey = false)
        {
            return XSalsa20StraightEncrypt(CipherText, Nonce, Key, IC, ClearKey);
        }
    }
