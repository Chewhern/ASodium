...
namespace ASodium
{
    public static partial class SodiumStreamCipherChaCha20Library
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_stream_chacha20_xor(Byte[] CipherText, Byte[] Message, long MessageLength, Byte[] Nonce, IntPtr Key);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_stream_chacha20_xor_ic(Byte[] CipherText, Byte[] Message, long MessageLength, Byte[] Nonce, ulong IC, IntPtr Key);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_stream_chacha20_ietf_xor(Byte[] CipherText, Byte[] Message, long MessageLength, Byte[] Nonce, IntPtr Key);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_stream_chacha20_ietf_xor_ic(Byte[] CipherText, Byte[] Message, long MessageLength, Byte[] Nonce, ulong IC, IntPtr Key);
    }
}
