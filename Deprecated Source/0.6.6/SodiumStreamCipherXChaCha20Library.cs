...
namespace ASodium
{
    public static partial class SodiumStreamCipherXChaCha20Library
    {
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_stream_xchacha20_xor(Byte[] CipherText, Byte[] Message, long MessageLength, Byte[] Nonce, IntPtr Key);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int crypto_stream_xchacha20_xor_ic(Byte[] CipherText, Byte[] Message, long MessageLength, Byte[] Nonce, ulong IC, IntPtr Key);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_stream_xchacha20_keygen(Byte[] Key);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void crypto_stream_xchacha20_keygen(IntPtr Key);
    }
}
