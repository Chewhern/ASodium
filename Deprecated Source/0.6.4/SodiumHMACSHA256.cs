...
namespace ASodium
{
    public static class SodiumHMACSHA256
    {

        public static int GetKeyBytesLength() 
        {
            return SodiumHMACSHA256Library.crypto_auth_hmacsha256_keybytes();
        }

        public static int GetComputedMACLength() 
        {
            return SodiumHMACSHA256Library.crypto_auth_hmacsha256_bytes();
        }
        ...
        public static Byte[] GenerateKey() 
        {
            ...
            SodiumHMACSHA256Library.crypto_auth_hmacsha256_keygen(Key);
        ...
        public static IntPtr GenerateKeyIntPtr()
        {
            ...
            {
                SodiumHMACSHA256Library.crypto_auth_hmacsha256_keygen(KeyIntPtr);
        ...
        public static Byte[] ComputeMAC(Byte[] Message,Byte[] Key,Boolean ClearKey=false) 
        {
            ...
            int result=SodiumHMACSHA256Library.crypto_auth_hmacsha256(ComputedMAC, Message, Message.LongLength, Key);
        ...
        public static Boolean VerifyMAC(Byte[] MAC,Byte[] Message, Byte[] Key,Boolean ClearKey=false) 
        {
            ...
            int result = SodiumHMACSHA256Library.crypto_auth_hmacsha256_verify(MAC, Message, Message.LongLength, Key);
