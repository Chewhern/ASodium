...
namespace ASodium
{
    public static class SodiumPublicKeyBoxXChaCha20Poly1305
    {
        ...
        public static KeyPair GenerateKeyPair()
        {
            ...
            {
                SodiumPublicKeyBoxXChaCha20Poly1305Library.crypto_box_curve25519xchacha20poly1305_keypair(PublicKeyIntPtr, SecretKeyIntPtr);
        ...
        public static KeyPair GenerateSeededKeyPair(IntPtr Seed,Boolean ClearKey=false)
        {
            ...
            if (IsZero1 == false && IsZero2 == false)
            {
                ...
                SodiumPublicKeyBoxXChaCha20Poly1305Library.crypto_box_curve25519xchacha20poly1305_seed_keypair(PublicKeyIntPtr, SecretKeyIntPtr, Seed);
        ...
        public static IntPtr GenerateSharedSecret(IntPtr CurrentUserSecretKey, Byte[] OtherUserPublicKey, Boolean ClearKey = false)
        {
        ...
        {
            if (CurrentUserSecretKey == IntPtr.Zero)
                throw new ArgumentException("Error: Secret key must not be empty/null");
