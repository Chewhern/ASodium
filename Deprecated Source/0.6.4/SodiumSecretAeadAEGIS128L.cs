...
namespace ASodium
{
    public static class SodiumSecretAeadAEGIS128L
    {
        public static int GetKeyLength()
        {
            return SodiumSecretAeadAEGIS128LLibrary.crypto_aead_aegis128l_keybytes();
        }

        public static int GetNoncePublicLength()
        {
            return SodiumSecretAeadAEGIS128LLibrary.crypto_aead_aegis128l_npubbytes();
        }
        ...
        {
            return SodiumSecretAeadAEGIS128LLibrary.crypto_aead_aegis128l_messagebytes_max();
        }
        ...
        public static Byte[] GenerateKey()
        {
            ...
            SodiumSecretAeadAEGIS128LLibrary.crypto_aead_aegis128l_keygen(Key);
            return Key;
        }
        ...
        public static IntPtr GenerateKey(ref Boolean IsZero)
        {
            ...
            {
                SodiumSecretAeadAEGIS128LLibrary.crypto_aead_aegis128l_keygen(KeyIntPtr);
