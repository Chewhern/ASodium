...
namespace ASodium
{
    public static class SodiumXOFSHAKE128
    {
        public static int GetBlockBytesLength() 
        {
            return SodiumXOFSHAKE128Library.crypto_xof_shake128_blockbytes();
        }

        public static int GetStateBytesLength() 
        {
            return SodiumXOFSHAKE128Library.crypto_xof_shake128_statebytes();
        }

        public static Byte GetDomainStandardByte() 
        {
            return SodiumXOFSHAKE128Library.crypto_xof_shake128_domain_standard();
        }
        ...
        public static Byte[] ComputeHash(Byte[] Message,long HashedMessageLength) 
        {
            ...
            int result = SodiumXOFSHAKE128Library.crypto_xof_shake128(HashedMessage,HashedMessageLength,Message,Message.LongLength);
        ...
        public static Byte[] InitStateBytes() 
        {
            ...
            int result = SodiumXOFSHAKE128Library.crypto_xof_shake128_init(State);
        ...
        public static Byte[] InitStateBytesWithCustomDomainByte(Byte CustomDomainByte) 
        {
            ...
            int result = SodiumXOFSHAKE128Library.crypto_xof_shake128_init_with_domain(State,CustomDomainByte);
        ...
        public static Byte[] UpdateState(Byte[] State, Byte[] DataStream,Boolean ClearKey=false) 
        {
            ...
            int result = SodiumXOFSHAKE128Library.crypto_xof_shake128_update(State, DataStream, DataStream.LongLength);
        ...
        public static IntPtr UpdateState(IntPtr State, IntPtr SecretDataStream, long SecretDataStreamLength,Boolean ClearKey = false) 
        {
            ...
            int result = SodiumXOFSHAKE128Library.crypto_xof_shake128_update(State, SecretDataStream, SecretDataStreamLength);
        ...
        public static Byte[] SqueezeData(Byte[] State,long SqueezedDataLength, Boolean ClearKey=false) 
        {
            ...
            int result = SodiumXOFSHAKE128Library.crypto_xof_shake128_squeeze(State, SqueezedData, SqueezedDataLength);
