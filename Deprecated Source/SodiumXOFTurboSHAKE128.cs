...
namespace ASodium
{
    public static class SodiumXOFTurboSHAKE128
    {
        public static int GetBlockBytesLength()
        {
            return SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128_blockbytes();
        }

        public static int GetStateBytesLength()
        {
            return SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128_statebytes();
        }

        public static Byte GetDomainStandardByte()
        {
            return SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128_domain_standard();
        }
        ...
        public static Byte[] ComputeHash(Byte[] Message, long HashedMessageLength)
        {
            ...
            int result = SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128(HashedMessage, HashedMessageLength, Message, Message.LongLength);
        ...
        public static Byte[] InitStateBytes()
        {
            ...
            int result = SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128_init(State);
        ...
        public static Byte[] InitStateBytesWithCustomDomainByte(Byte CustomDomainByte)
        {
            ...
            int result = SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128_init_with_domain(State, CustomDomainByte);
        ...
        public static Byte[] UpdateState(Byte[] State, Byte[] DataStream, Boolean ClearKey = false)
        {
            ...
            int result = SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128_update(State, DataStream, DataStream.LongLength);
        ...
        public static IntPtr UpdateState(IntPtr State, IntPtr SecretDataStream, long SecretDataStreamLength, Boolean ClearKey = false)
        {
            ...
            int result = SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128_update(State, SecretDataStream, SecretDataStreamLength);
        ...
        public static Byte[] SqueezeData(Byte[] State, long SqueezedDataLength, Boolean ClearKey = false)
        {
            ...
            int result = SodiumXOFTurboSHAKE128Library.crypto_xof_turboshake128_squeeze(State, SqueezedData, SqueezedDataLength);
