...
0.5.3 version
- Removed unnecessary code
- MAC in Salsa20Poly1305,ChaCha20Poly1305 and ChaCha20IETFPoly1305 in SodiumSecretBox no longer uses **System.Linq** and it uses **sodium_memcmp** to do the comparison with the MAC attached in the message.
